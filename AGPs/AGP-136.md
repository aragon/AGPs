...
# AGP-136: Association 2020 Budget
...
In order to fulfill the above responsibilities for the Aragon Network, the Association needs capital to support its team and cover Network-related expenses. These expenses include legal costs, HR, communications, accounting, banking, auditing, market making and more. While the goal is to decentralize these responsibilities to independent DAOs (as much as possible), currently they are essential to the health and producitivity of the Aragon Network.

Therefore, the Asociation requests authorization to use the following funds from the Aragon treasury:
...
The current full-time team is comprised of six people: 
